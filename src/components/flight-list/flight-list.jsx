    ...
    useEffect(() => {
        ...
        if (departure && arrival) {
            const endpoint = oneWayFlight
                ? `/flights?departure=${departure.code}&arrival=${arrival.code}&departureDate=${departureDate.format("YYYY-MM-DD")}&oneWayFlight=${oneWayFlight}&_sort=${filterType}`
                : `/flights?departure=${departure.code}&arrival=${arrival.code}&departureDate=${departureDate.format("YYYY-MM-DD")}&returnDate=${returnDate.format("YYYY-MM-DD")}&oneWayFlight=${oneWayFlight}&_sort=${filterType}`;
                                ...
                                flights.map((flight) => {
                                    ...
                                    return (
                                        <TableRow key={flight.id}>
                                            ...
                                            <TableCell>{arrival}</TableCell>
                                            <TableCell>{departureDate} {departureTime}</TableCell>
                                            <TableCell>{returnDate} {returnTime}</TableCell>
                                            <TableCell>
                                                {price} {currency}
                                            </TableCell>
